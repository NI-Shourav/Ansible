# Ansible: Run Playbook (echo) on Worker Nodes

Running an Ansible Playbook to execute an echo command and print the output on managed nodes using Ansible from a master EC2 instance.

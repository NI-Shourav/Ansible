# Ansible: Remote Nginx Installation on AWS EC2

Automating package updates and Nginx installation on managed nodes using Ansible from a master EC2 instance.
...
> [!NOTE]
> Replace `<MANAGED_NODE_PUBLIC_IP>` with the public IP address of either of your managed instances.

You should see the default **Welcome to nginx!** page, indicating a successful setup.
